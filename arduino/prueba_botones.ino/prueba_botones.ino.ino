...
void loop(void) {
  ...
  if (boton == 100)
  {
    if (banderita == 1)
    {
      ...
      pantalla.print("1");
      pantalla.setCursor(98, 0);
      pantalla.print("2");
      pantalla.setCursor(2, 45);
      pantalla.print("3");
      pantalla.setCursor(50, 45);
      pantalla.print("4");
      pantalla.setCursor(98, 45);
      pantalla.print("5");
      pantalla.setCursor(2, 90);
      pantalla.print("6");
      pantalla.setCursor(50, 90);
      pantalla.print("7");
      pantalla.setCursor(98, 90);
      pantalla.print("8");
      banderita = 0;
    }
  }
