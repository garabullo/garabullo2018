...
void juegos()
{
  ...
  pantalla.setTextSize(2);
  pantalla.setTextColor(VERDE);
  pantalla.setCursor(0, 9);
  pantalla.print("RESTA");
  pantalla.setTextColor(AZUL);
...
void records()
{
  ...
  pantalla.setTextSize(2);
  pantalla.setTextColor(VERDE);
  pantalla.setCursor(0, 0);   pantalla.print("SUMAS = ");   pantalla.print(EEPROM.read(13));
  pantalla.setCursor(0, 20);  pantalla.print("RESTA = ");   pantalla.print(EEPROM.read(16));
  pantalla.setCursor(0, 40);  pantalla.print("PROD. = ");   pantalla.print(EEPROM.read(15));
  pantalla.setCursor(0, 60);  pantalla.print("COMP. = ");   pantalla.print(EEPROM.read(17));
